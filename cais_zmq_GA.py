...
def main():
    ...
    algorithm = GeneticAlgorithm(
        ...
        offspring_population_size = 20, #100
        mutation = PolynomialMutation(1.0 / problem.number_of_variables, 100.0),
        crossover = SBXCrossover(0.9, 5.0),
        selection = BinaryTournamentSelection(),
        termination_criterion = StoppingByEvaluations(max_evaluations=400) #1000
    )
